...
class WaitlistController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // If product has flag and is out of stock, or generally allow waitlist usage:
        ...
        return response()->json($entry->load(['variant:id,name','product:id,name','customer:id,name,email']), 201);
    }
    ...
    public function convertToOrder(Request $request, Vendor $vendor, WaitlistEntry $entry)
    {
        ...
        // Create a scheduled delivery (fits your existing flow)
        // Assumes deliveries table has product_variant_id, qty, scheduled_date, status, vendor_location_id, customer_id, unit_price_cents, total_price_cents
